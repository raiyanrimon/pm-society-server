...
function isOneTimePackage(pkg: any): pkg is { amount: number; type: "one_time" } {
...
const startSubscriptionCheckout = catchAsync(async (req: Request, res: Response) => {
...
const completeSubscriptionRegistration = catchAsync(async (req: Request, res: Response) => {
...
const cancelSubscription = catchAsync(async (req: Request, res: Response) => {
  ...
  const subscription = await PaymentService.cancelSubscription(user.subscriptionId);
